...
from calc19 import CallStack
from calc19 import ErrorCode
from calc19 import Interpreter
from calc19 import Lexer
from calc19 import LexerError
from calc19 import Parser
from calc19 import ParserError
from calc19 import SemanticAnalyzer
from calc19 import SemanticError
from calc19 import TokenType
...
class TestCalc19(unittest.TestCase):
    ...
    def test_procedure_call(self):
        with open('data/part19.pas', 'r') as fin:
            text = fin.read()
        ...
        self.assertEqual(ar['a'], 5)
        self.assertEqual(ar['b'], 10)
        self.assertEqual(ar['x'], 70)
        self.assertEqual(ar.nesting_level, 3)

        interpreter.call_stack.real_pop()
        ar = interpreter.call_stack.peek()
        self.assertEqual(len(ar), 3)
    ...
    def test_program(self):
        ...
        self.assertAlmostEqual(ar['y'], float(20) / 7 + 3.14)
