...
from calc18 import CallStack
from calc18 import ErrorCode
from calc18 import Interpreter
from calc18 import Lexer
from calc18 import LexerError
from calc18 import Parser
from calc18 import ParserError
from calc18 import SemanticAnalyzer
from calc18 import SemanticError
from calc18 import TokenType

class TestCallStack(CallStack):
    def pop(self):
        pass

class TestCalc18(unittest.TestCase):
    ...
    def test_procedure_call(self):
        with open('data/part18.pas', 'r') as fin:
            text = fin.read()
