...
ID, ASSIGN, PROGRAM, VAR, COLON, COMMA = 'ID', 'ASSIGN', 'PROGRAM', 'VAR',  'COLON', 'COMMA'
REAL, INTEGER_TYPE, REAL_TYPE, REAL_DIV = 'REAL', 'Integer', 'Real', 'REAL_DIV'
...
class SymbolTableBuilder(NodeVistor):
    def __init__(self, output=True):
        self.symtab = SymbolTable(output)
